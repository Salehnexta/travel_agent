...
def test_flight_recognition():
    """Test flight recognition with airport codes"""
    ...
    # Process a direct flight request
    print("\n--- Processing Flight Request ---")
    flight_request = "find me flight from dmm to ruh tomorrow one way"
